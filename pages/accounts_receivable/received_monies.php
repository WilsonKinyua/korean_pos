                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Record Received Monies</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="received_monies.php" method="POST">
                                <input type="hidden" name="salesman" value="<?php echo $username; ?>">
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="row">
                                            <?php
                                            $query = $conn->query('SELECT id FROM received_moneys ORDER BY id DESC LIMIT 1');
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="doc_number" value="RCP-<?php echo $docId; ?>" class="form-control" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <label for="">Receipt Account: </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 text-right">
                                        ...
                                        <button type="submit" name="save_print" class="btn btn-primary" style="margin-left: 2em;">Save & Print</button>
                                    </div>
                        ...
                        if (isset($_SESSION['dont_close_alert'])){ ?>
                            <button hidden id="print" onclick="window.open('received_print.php?payment_id=<?= $_SESSION['dont_close_alert'] ?>', '_blank');"></button>
                        <?php }
                        ?>
                    </div>
                </div>
