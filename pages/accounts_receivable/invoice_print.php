        ...
        <tr class="top">
            <td colspan="2">
                <table>
                    <tr>
                        <td class="title">
                            <span class="t-invoice">
                                <img src="../../dist/img/favicon.png" style=" width:70px; height: 70px;">
                            </span>
                        </td>
...
<!--                            <span id="client-town"></span><br>-->
    ...
    <table class="invoice-items" cellpadding="0" cellspacing="0">
        <tr class="heading">
            ...
            <td style="width: 24%; text-align: center;"><span class="t-price">Unit Price</span></td>
            <td style="width: 24%; text-align: center;"><span class="t-price">Subtotal</span></td>
        </tr>
        <?php
        $taxTotal = 0;
        foreach ($productsPurchased as $product){ $taxTotal += $product['line_tax_total']; ?>
            <tr class="details">
                <td style="width: 28%; text-align: center;"><span class="t-item"><?= $product['product_name'] ?></span></td>
                <td style="width: 20%; text-align: center;"><span class="t-item"><?= $product['quantity'] ?></span></td>
                <td style="width: 24%; text-align: center;"><span class="t-item"><?= abs((float)$product['line_amount'] / $product['quantity']) ?></span></td>
                <td style="width: 24%; text-align: center;"><span class="t-price"><?= abs((float)$product['line_amount']) ?></span></td>
            </tr>
        <?php }
        ?>
    </table>
    ...
    <div class="invoice-summary">
        <div class="invoice-final">Tax Total: <?= $taxTotal ?></div>
