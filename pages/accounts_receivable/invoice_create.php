                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Make Credit Sale</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                                    ...
                                    <form method="post" action="invoice_create.php?page=cart">
                                                    ...
                                                    <tr>
                                                        ...
                                                        if (isset($_SESSION['invoice_customer'])) {
                                                            ...
                                                            if ($pricelist==1) {
                                                                ...
                                                                echo "<td>Kshs. ".number_format($tax, 2)."</td>";
                                        ...
                                        <div class="row col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="date" name="due_date" value="<?php echo date("Y-m-d"); ?>" min="<?php echo date("Y-m-d"); ?>" class="form-control">
                                            </div>
                                            <div class="col-md-4">
