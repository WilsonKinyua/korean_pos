                        ...
                        <div class="col-md-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Make Payment Against Bill </h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="doc_number" value="ACP-<?php echo $docId; ?>" class="form-control" readonly>
                                                    <span style="color: red;"><?php echo $doc_err; ?></span>
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="supplier_name">Supplier: <br><span style="color:red;"><?php
                                                    ...
                                                    if ($res->num_rows > 0) {
                                                        ...
                                                        while ($row = $res->fetch_assoc()) {
                                                            ...
                                                            <tr class="">
                                                                <td>
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input name="invoices[]" type="checkbox" class="custom-control-input select-invoice" value="<?= $row['id'] ?>" data-amount="<?= abs($row['total']) ?>" id="<?= $row['id'] ?>">
