        ...
        <section class="content">
          <div class="container-fluid mt-5">
            <div class="row">
              ...
              <?php if(isset($_GET["group_update"]) and !empty($_GET["group_update"])) { ?>

                <div class="col-md-4">
                    <!-- general form elements -->
                    <div class="card card-primary">
                      <div class="card-header">
                        <h3 class="card-title">Update Customer Group</h3>
                      </div>
                      <!-- /.card-header -->
                      <!-- form start -->
                      <form role="form" action="" method="POST">
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="exampleInputEmail1" placeholder="Enter name" value="<?php echo $group_row['name']; ?>">
                            <input type="hidden" name="id" value="<?php echo $group_row['id']; ?>">
                          ...
                          <div class="form-group" id="bottlesnumber">
                            ...
                            <input type="text" class="form-control" id="" name="percentage" placeholder="%" value="<?php echo $group_row['percentage']; ?>">
                          ...
                          <div class="card-footer">
                            <button type="submit" class="btn btn-primary" name="groups_update">Submit</button>
                          </div>
                      </div>
                    </form>
                  </div>
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  while ($row = $res->fetch_assoc()) {
                    ...
                    echo '<td><a href="groups.php?group_delete='.$row['id'].'" class="btn btn-xs btn-danger"><i class="fas fa-trash-alt"></i> Delete</a></td>';
                    echo '<td><a href="groups.php?group_update='.$row['id'].'" class="btn btn-xs btn-secondary"><i class="fas fa-pen-alt"></i> Update</a></td>';
                    }
                    echo "</tr>";
