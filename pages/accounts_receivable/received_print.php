...
$res = $conn->query("SELECT id FROM received_moneys where id='$paymentId' ");
if ($res->num_rows < 1){
...
$py = $conn->query("SELECT i.*,customers.cust_name, customers.cust_contact, pt.name as payment_type
    FROM received_moneys as i 
