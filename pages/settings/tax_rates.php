    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <?php if(isset($_GET['taxes_edit']) and !empty($_GET['taxes_edit'])) { ?>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <a styles="width: 100%; !important" href="tax_rates.php?taxes_delete=<?php echo $row["id"] ?>" class="btn btn-sm btn-danger">Delete</a>
                        </td>
                        <td>
                          <a styles="width: 100%; !important" href="tax_rates.php?taxes_edit=<?php echo $row["id"] ?>" class="btn btn-sm btn-secondary">Update</a>
                        </td>
                      </tr>
                    <?php
                      $number++;
