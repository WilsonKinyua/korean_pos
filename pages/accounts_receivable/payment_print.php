...
<div class="invoice-box rtl">
                ...
                <table>
                    <tr>
                        <td class="information-client">
                            <span class="t-invoice-to">PAYMENT FROM</span><br>
                        ...
                        <td class="information-company">
                            <span class="t-invoice-from">PAYMENT TO</span><br>
    ...
    <table class="invoice-items" cellpadding="0" cellspacing="0">
        <tr class="heading">
            <td><span class="t-item">Payment Method</span></td>
            <td><span class="t-price"></span></td>
        </tr>
        <?php
        $pid = $payment['payment_type'];
        $pm = $conn->query("SELECT name from payment_types where id ='$pid'");

        $pm = $pm->num_rows > 0 ? $pm->fetch_assoc()['name'] : '';

        ?>
        <tr class="details">
            <td><span class="t-item"><?= $pm ?></span></td>
            <td><span class="t-price"></span></td>
        </tr>
    </table>
